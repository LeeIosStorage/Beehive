...
- (void)addMJ {
    ...
    self.tableView.mj_header = [LERefreshHeader headerWithRefreshingBlock:^{
        ...
        [weakSelf getReceivedCommentList];
    }];
...
#pragma mark - Request
- (void)getReceivedCommentList {
    WEAKSELF
    NSString *requesUrl = [[WYAPIGenerate sharedInstance] API:@"GetReceivedCommentList"];
    ...
    NSString *caCheKey = [NSString stringWithFormat:@"GetReceivedCommentList"];
