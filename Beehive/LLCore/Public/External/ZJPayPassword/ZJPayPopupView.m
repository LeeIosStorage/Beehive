...
- (void)createUI
{
    ...
    [self mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.superView.mas_top).with.offset(XX_6(270));
    }];
...
//        make.height.mas_equalTo(XX_6(14));
    ...
    [self.titleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.mas_top).with.offset(XX_6(33));
...
- (void)showPayPopView
{
    ...
    [UIView animateWithDuration:kZJAnimationTimeInterval animations:^{
        ...
        strongSelf.superView.backgroundColor = kAppMaskOpaqueBlackColor;
    } completion:nil];
}
...
- (UIButton *)forgetPasswordButton
{
    if (!_forgetPasswordButton)
    {
        ...
        [_forgetPasswordButton setTitleColor:UIColorFromHEX(0xAAAAAA) forState:UIControlStateNormal];
